...
try {
    ...
    if (!$tableExists) {
        ...
        agentreqprice_charge_balance varchar(100)  NULL,
        ...
        addFieldToTable("setting", "agentreqprice_charge_balance", "offchargeagent", "VARCHAR(100)");
